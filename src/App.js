    ...
    <div>
      <Router>
        ...
        <Switch>
          ...
          <Route exact path={"/cliente/:id/pedidos"} component={PedidosCliente}/>
          <Route exact path={"/cliente/:id/compras"} component={ComprasCliente}/>
          ...
          <Route exact path="/editar-itempedido/:id" component={EditarItemPedido}/>
          <Route exact path="/inserir-itempedido" component={InserirItemPedido}/>
          <Route exact path="/listar-itempedido" component={ListarItemPedido} />
          <Route exact path="/editar-itemcompra/:id" component={EditarItemCompra}/>
