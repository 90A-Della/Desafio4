      ...
      <Container>
        ...
        <Form className="p-2" onSubmit={edtCliente}>
          <FormGroup className="p-2">
            ...
            <Input type="number" name="id" placeholder="id do Cliente" disabled defaultValue={id}/>
          </FormGroup>
          <FormGroup className="p-2">
            <Label>Nome:</Label>
            <Input type="text" name="nome" placeholder="Nome do Cliente" required defaultValue={nome} onChange={(e) => setNome(e.target.value)}/>
          </FormGroup>
          <FormGroup className="p-2">
            <Label>Endereço:</Label>
            <Input type="text" name="endereco" placeholder="Endereço" required defaultValue={endereco} onChange={(e) => setEndereco(e.target.value)}/>
          </FormGroup>
          <FormGroup className="p-2">
            <Label>Cidade:</Label>
            <Input type="text" name="cidade" placeholder="Cidade" required defaultValue={cidade} onChange={(e) => setCidade(e.target.value)}/>
          </FormGroup>
          <FormGroup className="p-2">
            <Label>UF:</Label>
            <Input type="text" name="uf" maxLength={2} placeholder="UF" required defaultValue={uf} onChange={(e) => setUf(e.target.value)}/>
          </FormGroup>
          <FormGroup className="p-2">
            <Label>Nascimento:</Label>
            <Input type="date" name="nascimento"  placeholder="Data de Nascimento" required defaultValue={nascimento} onChange={(e) => setNascimento(e.target.value)}/>
          </FormGroup>
          <FormGroup className="p-2">
            <Label>Cliente Desde:</Label>
            <Input type="date" name="clienteDesde" placeholder="Cliente Desde" required defaultValue={clienteDesde} onChange={(e) => setClienteDesde(e.target.value)}/>
          </FormGroup>
